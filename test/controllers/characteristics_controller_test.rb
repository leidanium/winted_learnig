...
class CharacteristicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create characteristic" do
    assert_difference('Characteristic.count') do
      post characteristics_url, params: { characteristic: { name: @characteristic.name, v_type: @characteristic.v_type } }
    end
  ...
  test "should update characteristic" do
    patch characteristic_url(@characteristic), params: { characteristic: { name: @characteristic.name, v_type: @characteristic.v_type } }
