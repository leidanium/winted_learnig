...
class AttributesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post attributes_url, params: { attribute: { name: @attribute.name, v_type: @attribute.v_type } }
    end
  ...
  test "should update attribute" do
    patch attribute_url(@attribute), params: { attribute: { name: @attribute.name, v_type: @attribute.v_type } }
