...
class SoldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sold" do
    assert_difference('Sold.count') do
      post solds_url, params: { sold: { article_id: @sold.article_id, closed: @sold.closed, price: @sold.price, user_id: @sold.user_id } }
    end
  ...
  test "should update sold" do
    patch sold_url(@sold), params: { sold: { article_id: @sold.article_id, closed: @sold.closed, price: @sold.price, user_id: @sold.user_id } }
